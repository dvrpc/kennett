...
define({
    ...
    "geographicalExtentLayer": "Study Area Buffer",
    ...
    "helpDialogContent": '<p>This tool is intended for reporting concerns and input on issues related to the Kennett Area Freight Transportation Study.</p><p><b>To get started select the green “Submit a Report” button.</b> This will open the reporting form for you to enter your comments.</p><p><b>1. Select Issue Type:</b><br>The form provides the option of reporting several types of input:<ul><li>Truck Routing - issues or concerns about the movements of trucks on a given street or neighborhood</li><li>Intersection Design - issues or concerns related to an intersection </li><li>Safety - input on a location or area where you perceive an unsafe condition or behavior by motor vehicles or other road users (bicyclists)</li><li>Bike/Pedestrian - input on bicycle or pedestrian user challenges, opportunities, and/or issues</li><li>Other - anything not represented by another category</li></ul></p><p><b>2. Describe the concern/issue:</b><br>The interface also provides a text box for you to describe in detail your concerns. Please be as specific as possible so that we can make the best use of your input in the formulation of recommendations. If additional space is required, comments can be added to the report after it is submitted.</p><p><b>3. Search or select the location:</b><br>Search using the location input or navigate to the point on the map that represents location of your concern. If the location is a route or larger area, select near the location and be sure this was specified in the description.</p><p><b>4. Submit your report</b></p><hr><p><b>Comment or Upvote on Existing Reports</b><br>In addition to reporting your own concerns, this tool allows you to explore other reported concerns/issues and provide feedback on them. Each reported concern is shown on the map as well as in the issues list.</p><p>Clicking on an icon in the map or item in the list will open the report, allowing access to more detail on the concern. From this expanded view you can:<ol><li>Upvote by clicking on the heart symbol – this signifies your endorsement or agreement with the report provided by another user; and/or</li><li>Comment by clicking on the message symbol – this allows you to add additional detail to the report in the corresponding comment form or contest a report added by another user.</li></ol></p><hr><p>If you have any questions or issues with the tool please reach out to Mike Ruane, Manager of Freight and Aviation Programs at DVRPC by phone (215.238.2888) or email (<a href="mailto:mruane@dvrpc.org">mruane@dvrpc.org</a>).</p>',
